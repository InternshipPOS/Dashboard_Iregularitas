...
<head>
    ...
    <title>Regional 6 | Iregularitas</title>
...
<body>
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Regional 6</span></h4>
            ...
            <a href="../user/monitoring_regional6.php" class="btn btn-success mb-3">Go to Monitoring</a>
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $total_sql = "SELECT COUNT(*) AS total FROM regional6";
                            ...
                            $sql = "SELECT * FROM regional6 LIMIT $limit OFFSET $offset";
                            ...
                            if ($result->num_rows > 0) :
                                while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <a href="../crud_user_reg6/update.php?id_sistem=<?php echo $row['id_sistem']; ?>" class="btn btn-primary">Edit</a>
                                            <!-- <a href="../crud_user_reg6/update.php" class="btn btn-danger delete-btn" data-id="<?php echo $row['id_sistem']; ?>">Delete</a> -->
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
