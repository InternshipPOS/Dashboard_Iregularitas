...
<head>
    ...
    <title>Regional 2 | Iregularitas</title>
...
<body>
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Regional 2</span></h4>
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $total_sql = "SELECT COUNT(*) AS total FROM regional2";
                            ...
                            $sql = "SELECT * FROM regional2 LIMIT $limit OFFSET $offset";
                            ...
                            if ($result->num_rows > 0) :
                                while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <a href="../crud_user_reg2/update.php?id_sistem=<?php echo $row['id_sistem']; ?>" class="btn btn-primary">Edit</a>
