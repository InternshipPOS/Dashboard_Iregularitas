...
<body>
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <a href="../user/monitoring_regional5.php" class="btn btn-success mb-3">Go to Monitoring</a>
                            ...
                            if ($result->num_rows > 0) :
                                while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <a href="../crud_user_reg5/update.php?id_sistem=<?php echo $row['id_sistem']; ?>" class="btn btn-primary">Edit</a>
                                            <!-- <a href="../crud_user_reg5/update.php" class="btn btn-danger delete-btn" data-id="<?php echo $row['id_sistem']; ?>">Delete</a> -->
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
