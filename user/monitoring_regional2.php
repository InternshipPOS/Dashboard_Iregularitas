...
<head>
    ...
    <title>Monitoring Regional 2</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Monitoring Regional 2</span></h4>

                        <!-- Back Button -->
                        <div class="mb-3">
<<<<<<< HEAD
                            <a href="user-setting-reg2.php" class="btn btn-primary">Back</a>
=======
                            <a href="../user/user-setting-reg2.php" class="btn btn-primary">Back</a>
