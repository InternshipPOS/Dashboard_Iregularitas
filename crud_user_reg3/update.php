        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        if ($koneksi->query($sql) === TRUE) {
                            ...
                            echo "<script>
                                Swal.fire({
                                    ...
                                    window.location.href = '../user/user-setting-reg3.php';
                                });
                            </script>";
                        } else {
                            echo "<script>
                    ...
                    $sql = "SELECT * FROM regional3 WHERE id_sistem='$id_sistem'";
                    ...
                    <form action="" method="POST">
                        ...
                        <a href="../user/user-setting-reg3.php" class="btn btn-secondary">Cancel</a>
                    </form>
