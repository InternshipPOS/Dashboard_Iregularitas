...
<head>
    ...
    <title>Edit Regional 3 | Iregularitas</title>
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        if ($koneksi->query($sql) === TRUE) {
                            ...
                            echo "<script>
                                Swal.fire({
                                    ...
                                    window.location.href = '../html/pages-regional settings-reg3.php';
                                });
                            </script>";
                        } else {
                            echo "<script>
                    ...
                    <form action="" method="POST">
                        ...
                        <a href="../html/pages-regional settings-reg3.php" class="btn btn-secondary">Cancel</a>
                    </form>
