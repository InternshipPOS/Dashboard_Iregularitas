...
VALUES 
    ('ID001', 'Reg Asal 1', 'Kantor Asal 1', 'NoPend Asal 1', STR_TO_DATE('05-01-2023 15:04:40', '%d-%m-%Y %H:%i:%s'), 'Januari', 'W01', '1.031.953', '1%', 2023, 'Reg Tujuan 1', 'Kantor Tujuan 1', 'NoPend Tujuan 1', 'Deskripsi Contoh', 'DNLN1', 'No Kiriman 1'),
    ('ID002', 'Reg Asal 2', 'Kantor Asal 2', 'NoPend Asal 2', STR_TO_DATE('06-02-2023 10:30:45', '%d-%m-%Y %H:%i:%s'), 'Februari', 'W02', '2.500.000', '2%', 2023, 'Reg Tujuan 2', 'Kantor Tujuan 2', 'NoPend Tujuan 2', 'Deskripsi Contoh 2', 'DNLN2', 'No Kiriman 2');
