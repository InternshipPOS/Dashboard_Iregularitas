...
<head>
    ...
    <title>Edit Regional 2 | Iregularitas</title>
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        if ($koneksi->query($sql) === TRUE) {
                            ...
                            echo "<script>
                                Swal.fire({
                                    ...
                                    window.location.href = '../user/user-setting-reg2.php';
                                });
                            </script>";
                        } else {
                            echo "<script>
                    ...
                    $sql = "SELECT * FROM regional2 WHERE id_sistem='$id_sistem'";
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="reg_asal_p6" name="reg_asal_p6_display" value="<?php echo $row['reg_asal_p6']; ?>" disabled>
                            <input type="hidden" name="reg_asal_p6" value="<?php echo $row['reg_asal_p6']; ?>">
                        </div>

                        <!-- Kantor Asal P6 -->
                        <div class="mb-3">
                            <label for="kantor_asal_p6" class="form-label">Kantor Asal P6</label>
                            <input type="text" class="form-control" id="kantor_asal_p6" name="kantor_asal_p6_display" value="<?php echo $row['kantor_asal_p6']; ?>" disabled>
                            <input type="hidden" name="kantor_asal_p6" value="<?php echo $row['kantor_asal_p6']; ?>">
                        </div>

                        <!-- No Pend Asal P6 -->
                        <div class="mb-3">
                            <label for="nopend_asal_p6" class="form-label">No Pend Asal P6</label>
                            <input type="text" class="form-control" id="nopend_asal_p6" name="nopend_asal_p6_display" value="<?php echo $row['nopend_asal_p6']; ?>" disabled>
                            <input type="hidden" name="nopend_asal_p6" value="<?php echo $row['nopend_asal_p6']; ?>">
                        </div>

                        <!-- Tanggal Berita Acara -->
                        <div class="mb-3">
                            <label for="tanggal_berita_acara" class="form-label">Tanggal Berita Acara</label>
                            <input type="date" class="form-control" id="tanggal_berita_acara" name="tanggal_berita_acara_display" value="<?php echo date('Y-m-d', strtotime($row['tanggal_berita_acara'])); ?>" disabled>
                            <input type="hidden" name="tanggal_berita_acara" value="<?php echo $row['tanggal_berita_acara']; ?>">
                        </div>

                        <!-- Bulan -->
                        <div class="mb-3">
                            <label for="bulan" class="form-label">Bulan</label>
                            <input type="text" class="form-control" id="bulan" name="bulan_display" value="<?php echo $row['bulan']; ?>" disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="week" name="week_display" value="<?php echo $row['week']; ?>" disabled>
                            <input type="hidden" name="week" value="<?php echo $row['week']; ?>">
                        </div>

                        <!-- Tahun -->
                        <div class="mb-3">
                            <label for="tahun" class="form-label">Tahun</label>
                            <input type="text" class="form-control" id="tahun" name="tahun_display" value="<?php echo $row['tahun']; ?>" disabled>
                            <input type="hidden" name="tahun" value="<?php echo $row['tahun']; ?>">
                        </div>

                        <!-- Reg Tujuan P6 -->
                        <div class="mb-3">
                            <label for="reg_tujuan_p6" class="form-label">Reg Tujuan P6</label>
                            <input type="text" class="form-control" id="reg_tujuan_p6" name="reg_tujuan_p6_display" value="<?php echo $row['reg_tujuan_p6']; ?>" disabled>
                            <input type="hidden" name="reg_tujuan_p6" value="<?php echo $row['reg_tujuan_p6']; ?>">
                        </div>

                        <!-- Kantor Tujuan P6 -->
                        <div class="mb-3">
                            <label for="kantor_tujuan_p6" class="form-label">Kantor Tujuan P6</label>
                            <input type="text" class="form-control" id="kantor_tujuan_p6" name="kantor_tujuan_p6_display" value="<?php echo $row['kantor_tujuan_p6']; ?>" disabled>
                            <input type="hidden" name="kantor_tujuan_p6" value="<?php echo $row['kantor_tujuan_p6']; ?>">
                        </div>

                        <!-- Nopend Tujuan P6 -->
                        <div class="mb-3">
                            <label for="nopend_tujuan_p6" class="form-label">Nopend Tujuan P6</label>
                            <input type="text" class="form-control" id="nopend_tujuan_p6" name="nopend_tujuan_p6_display" value="<?php echo $row['nopend_tujuan_p6']; ?>" disabled>
                            <input type="hidden" name="nopend_tujuan_p6" value="<?php echo $row['nopend_tujuan_p6']; ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="deskripsi" name="deskripsi_display" disabled><?php echo $row['deskripsi']; ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="dnln" name="dnln_display" value="<?php echo $row['dnln']; ?>" disabled>
                            <input type="hidden" name="dnln" value="<?php echo $row['dnln']; ?>">
                        </div>

                        <!-- Nomor Kiriman -->
                        <div class="mb-3">
                            <label for="nomor_kiriman" class="form-label">Nomor Kiriman</label>
                            <input type="text" class="form-control" id="nomor_kiriman" name="nomor_kiriman_display" value="<?php echo $row['nomor_kiriman']; ?>" disabled>
                            <input type="hidden" name="nomor_kiriman" value="<?php echo $row['nomor_kiriman']; ?>">
                        </div>

                        <!-- Uraian Berita Acara -->
                        <div class="mb-3">
                            <label for="uraian_berita_acara" class="form-label">Uraian Berita Acara</label>
                            <textarea class="form-control" id="uraian_berita_acara" name="uraian_berita_acara_display" rows="3" disabled><?php echo $row['uraian_berita_acara']; ?></textarea>
                            <input type="hidden" name="uraian_berita_acara" value="<?php echo $row['uraian_berita_acara']; ?>">
                        </div>

                        <!-- Deskripsi Iregularitas -->
                        <div class="mb-3">
                            <label for="deskripsi_iregularitas" class="form-label">Deskripsi Iregularitas</label>
                            <textarea class="form-control" id="deskripsi_iregularitas" name="deskripsi_iregularitas_display" disabled><?php echo $row['deskripsi_iregularitas']; ?></textarea>
                            <input type="hidden" name="deskripsi_iregularitas" value="<?php echo $row['deskripsi_iregularitas']; ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="validasi_pusat" value="<?php echo $row['validasi_pusat']; ?>">
                        </div>

                        <button type="submit" class="btn btn-primary">Update</button>
                        <a href="../user/user-setting-reg2.php" class="btn btn-secondary">Cancel</a>
                    </form>
