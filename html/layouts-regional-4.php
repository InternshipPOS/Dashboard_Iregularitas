...
<head>
    ...
    <style>
        body {
            ...
            /* Background yang lebih terang dan lembut */
        }
        ...
        h1 {
            ...
            /* Menambahkan bayangan halus untuk efek cantik */
        }
        ...
        th {
            ...
            /* Garis bawah yang lebih gelap untuk kontras */
            ...
            /* Spasi antar huruf */
            font-weight: 600;
            /* Menegaskan ketebalan teks */
            transition: background-color 0.3s ease;
            /* Animasi transisi halus untuk background */
        }
        ...
        td {
            ...
            /* Teks rata tengah */
            padding: 12px;
            /* Sedikit lebih besar untuk ruang lebih luas */
            border: 1px solid #dee2e6;
            /* Border halus untuk pemisahan data */
            background-color: #f8f9fa;
            /* Warna background yang lembut */
            font-size: 14px;
            /* Ukuran font yang pas */
            color: #495057;
            /* Warna teks yang lembut dan mudah dibaca */
            transition: background-color 0.3s ease, transform 0.3s ease;
            /* Transisi halus untuk interaksi hover */
        }

        td:hover {
            background-color: #e2e6ea;
            /* Warna latar lebih gelap saat di-hover */
            transform: scale(1.02);
            /* Sedikit memperbesar ukuran untuk efek hover */
            cursor: pointer;
            /* Menambahkan kursor pointer saat di-hover */
        }

        tr:nth-child(even) td {
            background-color: #e9ecef;
            /* Warna background berbeda untuk baris genap */
        }

        tr:hover td {
            background-color: #d1ecf1;
            /* Warna background biru muda saat baris di-hover */
        }
...
<body>
    ...
    <script>
        ...
        document.getElementById('backButton').addEventListener('click', function() {
            window.location.href = '../html/index.php'; // Redirects to index.php
        });
