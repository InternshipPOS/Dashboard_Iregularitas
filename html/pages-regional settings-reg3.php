                            ...
                            if ($result->num_rows > 0) :
                                while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <a href="../crud_regional3/update.php?id_sistem=<?php echo $row['id_sistem']; ?>" class="btn btn-primary">Edit</a>
                                            <a href="../crud_regional3/delete.php" class="btn btn-danger delete-btn" data-id="<?php echo $row['id_sistem']; ?>">Delete</a>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
                                <tr>
