        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="layouts-regional-1.php" class="menu-link">
                    <div data-i18n="Without menu">Regional-1</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="layouts-regional-2.php" class="menu-link">
                    <div data-i18n="Without navbar">Regional-2</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="layouts-regional-3.php" class="menu-link">
                    <div data-i18n="Container">Regional-3</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="layouts-regional-4.php" class="menu-link">
                    <div data-i18n="Fluid">Regional-4</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="layouts-regional-5.php" class="menu-link">
                    <div data-i18n="Fluid">Regional-5</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="layouts-regional-6.php" class="menu-link">
                    <div data-i18n="Fluid">Regional-6</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Regional Settings</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
