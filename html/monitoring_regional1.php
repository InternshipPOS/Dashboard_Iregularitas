...
<head>
    ...
    <title>Monitoring Regional 1</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Monitoring Regional 1</span></h4>

                        <!-- Back Button -->
                        <div class="mb-3">
                            <a href="pages-regional settings-reg1.php" class="btn btn-primary">Back</a>
                        </div>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                © <script>document.write(new Date().getFullYear());</script>, made with ❤️ by ARYKA JUWITA RIZKYRIA
                            </div>
                        </div>
                    </footer>
